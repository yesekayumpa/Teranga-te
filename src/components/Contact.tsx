...
// ── Coordonnées Liberté 6 Extension, Dakar ────────────────────────
...
// ── Carte Leaflet chargée dynamiquement (pas de build-step requis) ─
const LeafletMap: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      // Icône custom couleur or Teranga
      ...
      // Marqueur + popup
      L.marker([TERANGA_LAT, TERANGA_LNG], { icon })
        .addTo(map)
        .bindPopup(`
          <div style="font-family:system-ui,sans-serif; padding:4px 2px; min-width:200px;">
            <div style="font-weight:800; font-size:14px; color:#1a2740; margin-bottom:4px;">
              ${TERANGA_LABEL}
            </div>
            ...
            <a
              ...
              style="
                ...
                color:#C29941; text-decoration:none; letter-spacing:0.05em;
              "
            >
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              {step === 4 && (
                <motion.div key="step4" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="success-state">
                  ...
                  <motion.button
                    onClick={() => setStep(1)}
                    style={{ marginTop: 24, color: 'var(--gold-600)', fontWeight: 700, fontSize: 14, letterSpacing: '0.12em', textTransform: 'uppercase', background: 'none', border: 'none', cursor: 'pointer' }}
        ...
        >
          <div className="maps-head">
            ...
            <div>
              ...
              <div className="a">{TERANGA_LABEL} — {TERANGA_ADDRESS}</div>
            </div>
            <motion.a
              className="maps-cta"
              href={mapsLink}
          ...
          {/* Carte Leaflet — marqueur 100% contrôlé, nom Teranga TE garanti */}
